...
namespace Plantilla_Examen_Marc_Llorca.FORMS
{
    public partial class FrmModuls : Form
    {
        ...
        private void btNou_Click(object sender, EventArgs e)
        {
            ...
            if (frm.hanfetOK)
            {
                MessageBox.Show("Has Modificat el modul :" + ctrlModuls.idModul, "SUCCES", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btDel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Has borrat el modul :" + ctrlModuls.idModul, "SUCCES", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    getDades();
