...
namespace CLASSES
{
    public class ClFamilies
    {
        ...
        private Boolean verificarId(String xid)
        {
            ...
            {
                MessageBox.Show("Has posat malamemt la id de FAMILIA, recorda que ha de tenir entre 3-5 digits i TOT MAJUSCULES ", "Modificació Familia", MessageBoxButtons.OK);
            }
            return xb;
        }
        ...
        private Boolean verificarNom(String xnom)
        {
            ...
            {
                MessageBox.Show("Has posat malament el nom de FAMILIA ", "Modificació Familia", MessageBoxButtons.OK);
            }
            return xb;
        }
